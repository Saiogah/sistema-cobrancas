...
function EmptyStateBase({ title, description }: EmptyStateProps) {
  ...
  if (isDashboardEmpty) {
    return React.createElement(
      "div",
      { className: "surface-card mx-auto w-full max-w-lg bg-gradient-to-b from-card to-card/90 px-6 py-8 text-center sm:px-9" },
      React.createElement(
        "div",
      ...
      React.createElement(
        ...
        {
          to: "/cobrancas",
          className: "mt-5 inline-flex h-10 items-center justify-center rounded-xl bg-primary px-5 text-sm font-semibold text-primary-foreground shadow-soft transition hover:bg-primary/90",
        },
        "Ver cobranças",

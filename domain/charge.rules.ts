...
// M14 usa as regras de autorização de edição/exclusão pela camada de charge rules.
// A implementação continua única em parcel.rules para não duplicar regra de negócio.
export { podeEditarCobranca, podeExcluirCobranca } from './parcel.rules';
